...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        persona1.setSexo(sexoPersona1.charAt(0));
        persona1.setEdad(edadPersona1);
        persona1.setPeso(pesoPersona1);
        persona1.setAltura(alturaPersona1);
        ...
        persona2.setEdad(edadPersona2);
        persona2.setSexo(sexoPersona2.charAt(0));
